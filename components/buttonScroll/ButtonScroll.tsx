...
const ButtonScroll: React.FC = () => {
    ...
    return (
        <button
            className="fixed w-[50px] h-[50px] bg-[#007bff] border-[1px] border-[#007bff] text-white rounded-full right-[40px] bottom-[30px] cursor-pointer transition-all duration-500 z-[100] hover:bg-white hover:text-[#007bff]"
