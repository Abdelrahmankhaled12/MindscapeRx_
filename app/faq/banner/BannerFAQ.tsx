...
const BannerFAQ = () => {
    return (
        <div>
            ...
            <section
                className="relative md:h-[70vh] bg-cover bg-bottom md:bg-top" // Classes for background styling
            ...
            >
                ...
                <div className="absolute inset-0 bg-[#00000058]"></div>
                <Image src={logo} alt="Logo" className=" absolute top-1/2 left-1/2 opacity-40 transform -translate-x-1/2 -translate-y-1/2" />
                ...
                <div className="relative z-10 h-full flex flex-col justify-end mb-[30px] text-white px-4 pb-[60px]">
                    ...
                    <div className='w-full max-w-[1400px] mx-auto px-5 py-3 xl:px-0 xl:py-4'>
                        ...
                        <h1 className="text-[40px]  md:text-[50px] font-bold text-transparent bg-clip-text bg-[#ffffff]" data-aos="fade-right" data-aos-delay="100" data-aos-duration="800">
                            Frequently Asked <span className="bg-clip-text bg-gradient-to-r from-[#04fe5f] to-yellow-400"
