    ...
    return (
        <div>
            ...
            >
                ...
                <div className="relative z-10 h-full flex flex-col justify-end mb-[30px] text-white px-4 pb-[80px]">
                    ...
                    <div className='w-full max-w-[1400px] mx-auto px-5 py-3 xl:px-0 xl:py-4'>
                        ...
                        <h1 className="text-[35px] sm:text-[50px] md:text-[70px] font-bold text-transparent bg-clip-text bg-[#ffffff]" data-aos="fade-right" data-aos-delay="100" data-aos-duration="800">
                            How <span className="bg-clip-text bg-gradient-to-r from-green-400 to-yellow-400">Our Program </span> Works.
                        </h1>
                    </div>
                </div>
            </section>
