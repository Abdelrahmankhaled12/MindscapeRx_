...
const Steps = () => {
    return (
        <div className='bg-[#ffffff] relative top-[-40px] pt-[40px] pb-[80px] rounded-tl-[50px] rounded-tr-[50px] overflow-hidden text-center'>
            <ContentWrapper>
                {/* Steps Container */}
                <div className='relative steps'>
                    ...
                    <div className='mb-[90px]'>
                        <div className="flex items-center justify-center bg-[#ffffff] z-10 relative">
                            <div className="px-10 pt-[2px] pb-[2px] border border-teal-400 rounded-full bg-blue-50">
                                <span className="text-[50px] text-transparent bg-clip-text font-medium"
                                    style={{ backgroundImage: "linear-gradient(0deg, #2e83c1eb 0%, #74e79e 40%, #e4ce0e 96%)" }}
                                >
                                    Step 1
                                </span>
                            </div>
                    ...
                    <div className="mb-[90px]">
                        ...
                        {/* Risk-Free Guarantee */}
                        <div className="bg-[#ffffffbd] z-10 p-6 rounded-[40px] shadow-md border-[1px] border-black w-full max-w-[530px] relative overflow-hidden mx-auto rounded-b-[0px]">
